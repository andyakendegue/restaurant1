                ...
                <ul style="height: 172px; overflow: hidden;" class="fetched_tweets">
                    ...
                    <li style="margin-top: 0px;" class="tweets_avatar">
                        <div class="tweet_wrap">
                            ...
                            <div class="tweet_data">
	        					RT
                                <a href="http://twitter.com/BibleIsGodsWord" target="_blank" rel="nofollow">@BibleIsGodsWord</a>: Matt. 8:8 - “Lord, I am not worthy to have you enter under my roof; only say the word and my servant will be healed."
                        ...
                        <div class="uk-width-1-1">
                            <div class="uk-grid uk-grid-collapse">
                                <div class="uk-grid-width-small-1-1 uk-width-medium-1-2 tm-widget-lastdonations-image">
                                    <img src="./images/gall-img-011.jpg" class="attachment-full wp-post-image" alt="gall-img-011" height="1570" width="2000">
                                </div>
                        ...
                        <ul class="uk-slider uk-grid uk-grid-collapse uk-grid-width-small-1-2 uk-grid-width-medium-1-4 uk-grid-width-large-1-6 uk-grid-width-xlarge-1-6">
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-011.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-011.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-014.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-014.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                	<img draggable="false" class="uk-overlay-scale" src="./images/gall-img-015.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-015.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-0171.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-0171.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-013.jpg" alt="gall-img-013" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-013.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-010.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-010.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-012.jpg" alt="" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-012.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-016.jpg" alt="gall-img-016" height="1570" width="2000">
                                </figure>
                                <a draggable="false" class="uk-position-cover" data-uk-lightbox="{group:'gallery-group'}" data-lightbox-type="image" href="./images/gall-img-016.jpg"></a>
                            </li>
                            <li>
                                <figure class="uk-overlay uk-overlay-hover">
                                    <img draggable="false" class="uk-overlay-scale" src="./images/gall-img-011.jpg" alt="" height="1570" width="2000">
                    ...
                    <div class="tm-wrap uk-grid-collapse">
                        <div class="tm-latest-post-widget clearfix">
                            ...
                            <div class="post-image">
                                <img src="./images/post-img-001.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="post-img-001" height="100" width="100">
                            </div>
                            <div class="post-text">
                                <h3 class="uk-panel-header">
                        ...
                        <div class="tm-latest-post-widget clearfix">
                            ...
                            <div class="post-image">
                                <img src="./images/post-img-002.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="post-img-002" height="100" width="100">
                            </div>
                            <div class="post-text">
                                <h3 class="uk-panel-header">
                        ...
                        <div class="tm-latest-post-widget clearfix">
                            ...
                            <div class="post-image">
                                <img src="./images/post-img-003.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="post-img-003" height="100" width="100">
                            </div>
                            <div class="post-text">
                                <h3 class="uk-panel-header">
                        ...
                        <div class="tm-latest-post-widget clearfix">
                            ...
                            <div class="post-image">
                                <img src="./images/post-img-004.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="post-img-004" height="100" width="100">
                            </div>
                            <div class="post-text">
                                <h3 class="uk-panel-header">
                        ...
                        <div class="tm-latest-post-widget clearfix">
                            ...
                            <div class="post-image">
                                <img src="./images/post-img-005.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="gall-img-016" height="100" width="100">
                            </div>
                            <div class="post-text">
                                <h3 class="uk-panel-header">
                    ...
                    <div class="uk-panel tm-location-widget" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat: true}">
                        <div class="uk-grid tm-location-box uk-grid-collapse">
                            ...
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 ">
                                <a href="#" class="">
                                    <img src="./images/gall-img-016.jpg" class="attachment-full wp-post-image" alt="gall-img-016" height="1570" width="2000">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="uk-panel tm-location-widget" data-uk-scrollspy="{cls:'uk-animation-slide-left', repeat: true}">
                        <div class="uk-grid tm-location-box uk-grid-collapse">
                            ...
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-pull-1-2 ">
                                <a href="#" class="">
                                    <img src="./images/gall-img-0022.jpg" class="attachment-full wp-post-image" alt="gall-img-002" height="1340" width="2000">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="uk-grid uk-slideset uk-grid-width-1-1 uk-grid-width-large-1-2 uk-grid-width-medium-1-2 uk-grid-width-small-1-1">
                                    ...
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_001.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_001" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li class="uk-active" style="">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_pastors_002.jpg" class="attachment-thumbnail wp-post-image" alt="img_pastors_002" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_004.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_004" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_002.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_002" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_pastors_005.jpg" class="attachment-thumbnail wp-post-image" alt="img_pastors_005" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_003.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_003" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_005.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_005" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
                                ...
                                <li style="display: none;">
                                    <div class="uk-panel">
                                        <p>
                                            <span class="circle-border">
                                                <img src="./images/img_testim_006.jpg" class="attachment-thumbnail wp-post-image" alt="img_testim_006" height="164" width="164">
                                            </span>
                                        </p>
                                        <h3 class="uk-panel-header">
                                            <span class="brackets">
        ...
        <div class="uk-width-1-1">
            <div class="uk-panel CutePartners" >
                <div data-uk-slider="{center:true}" >
                    <div class="uk-slider-container">
                        <div class="uk-slider">
                            <img width="227" height="160" src="./images/partner-002_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-002_01" />
                            <img width="227" height="160" src="./images/partner-003_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-003_01" />
                            <img width="227" height="160" src="./images/partner-001_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-001_01" />
                            <img width="227" height="160" src="./images/partner-004_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-004_01" />
                            <img width="227" height="160" src="./images/partner-005_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-005_01" />
                            <img width="227" height="160" src="./images/partner-006_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-006_01" />
                            <img width="227" height="160" src="./images/partner-007_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-007_01" />
                            <img width="227" height="160" src="./images/partner-008_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-008_01" />
                            <img width="227" height="160" src="./images/partner-009_01.png" class="attachment-post-thumbnail wp-post-image" alt="partner-009_01" />
                        </div>
                    </div>
                </div>
            </div>
