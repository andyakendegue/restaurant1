  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading"><H2>Nouveau plat</H2><button class="btn btn-primary">Ajouter un plat</button></div>
        ...
        <div class="panel-body">
          ...
          <form method="post" class="addMenu" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="composition">Composition</label><input class="form-control" id="composition" name="composition" type="text" />
            </div>
            <div class="form-group">
              <label for="prix">Prix</label><input class="form-control" id="prix" name="prix" type="text" />
            </div>
